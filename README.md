![image](https://github.com/user-attachments/assets/0223f571-7283-422d-8d23-6e94a0662d43)这是一个超级轻量的.xlsx读取并应用其数据的工具。 |  This is a super lightweight tool for reading.xlsx files and applying their data.
